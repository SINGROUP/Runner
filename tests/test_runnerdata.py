...
def test_runnerdata():
    ...
    success = {
        ...
        "tasks": [
            ["shell", "export OMP_NUM_THREADS=1"],
            ["python", "energy.py"],
    ...
    (scheduler_options, name, parents, tasks, files) = run.get_runner_data()
    ...
    fail[2] = {
        "name": "energy calculation",
        "tasks": [["shell", "export OMP_NUM_THREADS=1"], ["python", "energy.py"]],
        "files": [],
        "scheduler_options": {"-N": 5},
        "keep_run": True,
    }
    ...
    fail[3] = {
        "name": "energy calculation",
        "tasks": [["shell", "export OMP_NUM_THREADS=1"], ["python", "energy1.py"]],
        "files": {"energy.py": energy_calculation},
        "scheduler_options": {"-N": 5},
        "keep_run": True,
    }
    ...
    fail[8] = {
        "name": "energy calculation",
        "tasks": [["shell", 1], ["python", "energy.py"]],
        "files": {"energy.py": energy_calculation},
        "parents": [1, 2],
        "scheduler_options": {"-N": 5},
        "keep_run": True,
    ...
    fail[9] = {
        "name": "energy calculation",
        "tasks": [["shell", "export OMP_NUM_THREADS=1"], ["python", 1]],
        "files": {"energy.py": energy_calculation},
        "parents": [1, 2],
        "scheduler_options": {"-N": 5},
        "keep_run": True,
    ...
    fail[10] = {
        "name": "energy calculation",
        "tasks": [["shell", "export OMP_NUM_THREADS=1"], ["python", []]],
        "files": {"energy.py": energy_calculation},
        "parents": [1, 2],
        "scheduler_options": {"-N": 5},
        "keep_run": True,
...
def test_to_from_data():
    ...
    (scheduler_options, name, parents, tasks, files) = runner.get_runner_data()
    assert name == "energy calculation"
    assert len(parents) == 2
    assert parents[0] == 1 and parents[1] == 2
    assert isinstance(scheduler_options, dict)
